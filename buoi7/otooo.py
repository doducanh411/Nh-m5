...
try:
    ...
    print(f"Error loading oto.png: {e}")

try:
    nui_img = pygame.image.load('nui.png')
    nui_img = pygame.transform.scale(nui_img, (100, 200))  # Chỉnh kích thước ảnh núi
except pygame.error as e:
    print(f"Error loading nui.png: {e}")

# Xe tải
xe_tai = oto_img.get_rect(center=(100, chieu_rong // 2))  # Đặt xe tải ở bên trái, không va chạm với núi
toc_do_xe = 5
